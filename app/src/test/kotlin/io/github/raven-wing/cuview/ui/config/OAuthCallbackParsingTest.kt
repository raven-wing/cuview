...
import io.github.raven_wing.cuview.ui.main.OAuthResult
...
// Regression tests for MainActivity.parseOAuthCallback — the function that
...
class OAuthCallbackParsingTest {
    ...
    fun validToken_returnsSuccess() {
        ...
        assertEquals(OAuthResult.Success("pk_abc123"),
            MainActivity.parseOAuthCallback(uri))
    }
    ...
    fun wrongScheme_returnsNull() {
        ...
        assertNull(MainActivity.parseOAuthCallback(uri))
    }
