...
import io.github.raven_wing.cuview.ui.config.OAuthResult
import io.github.raven_wing.cuview.ui.config.WidgetConfigActivity
...
// Regression tests for WidgetConfigActivity.parseOAuthCallback — the function that
...
class OAuthCallbackParsingTest {
    ...
    fun validToken_returnsSuccess() {
        ...
        assertEquals(OAuthResult.Success("pk_abc123"),
            WidgetConfigActivity.parseOAuthCallback(uri))
    }
    ...
    fun wrongScheme_returnsNull() {
        ...
        assertNull(WidgetConfigActivity.parseOAuthCallback(uri))
    }
