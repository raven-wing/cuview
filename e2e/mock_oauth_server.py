...
The emulator reaches the host machine at 10.0.2.2, so start this server on the
host before running the E2E suite (the Makefile does this automatically).

Port must match MOCK_OAUTH_PORT in ConfigScreen.kt.
"""
import os
import sys
